...
interface AuthRemoteDataSource {
    ...
    suspend fun signIn(signInRequestDto: SignInRequestDto): NullableBaseResponse<SignInResponseDto>
    suspend fun getMyNickName(userId: Long): NullableBaseResponse<GetMyNickNameResponseDto>
}